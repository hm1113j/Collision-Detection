...
/* SensorBus_SCBCLK */
#define SensorBus_SCBCLK__DIV_IDX 1
#define SensorBus_SCBCLK__DIV_NUM 1
#define SensorBus_SCBCLK__DIV_TYPE CY_SYSCLK_DIV_8_BIT

/* Miscellaneous */
#define Clock_Echo__DIV_IDX 0
#define Clock_Echo__DIV_NUM 0
#define Clock_Echo__DIV_TYPE CY_SYSCLK_DIV_8_BIT
#define Timer_Echo_1_TCPWM__CNT_HW TCPWM0_CNT3
#define Timer_Echo_1_TCPWM__CNT_IDX 3u
#define Timer_Echo_1_TCPWM__HW TCPWM0
#define Timer_Echo_1_TCPWM__IDX 0u
#define Timer_Echo_2_TCPWM__CNT_HW TCPWM0_CNT6
#define Timer_Echo_2_TCPWM__CNT_IDX 6u
#define Timer_Echo_2_TCPWM__HW TCPWM0
#define Timer_Echo_2_TCPWM__IDX 0u
#define Timer_Echo_3_TCPWM__CNT_HW TCPWM0_CNT5
#define Timer_Echo_3_TCPWM__CNT_IDX 5u
#define Timer_Echo_3_TCPWM__HW TCPWM0
#define Timer_Echo_3_TCPWM__IDX 0u
#define Timer_Echo_TCPWM__CNT_HW TCPWM0_CNT4
#define Timer_Echo_TCPWM__CNT_IDX 4u
#define Timer_Echo_TCPWM__HW TCPWM0
#define Timer_Echo_TCPWM__IDX 0u
#define PWM_Trigger_1_TCPWM__CNT_HW TCPWM0_CNT7
#define PWM_Trigger_1_TCPWM__CNT_IDX 7u
#define PWM_Trigger_1_TCPWM__HW TCPWM0
#define PWM_Trigger_1_TCPWM__IDX 0u
#define PWM_Trigger_2_TCPWM__CNT_HW TCPWM0_CNT1
#define PWM_Trigger_2_TCPWM__CNT_IDX 1u
#define PWM_Trigger_2_TCPWM__HW TCPWM0
#define PWM_Trigger_2_TCPWM__IDX 0u
#define PWM_Trigger_3_TCPWM__CNT_HW TCPWM0_CNT0
#define PWM_Trigger_3_TCPWM__CNT_IDX 0u
#define PWM_Trigger_3_TCPWM__HW TCPWM0
#define PWM_Trigger_3_TCPWM__IDX 0u
#define PWM_Trigger_TCPWM__CNT_HW TCPWM0_CNT2
#define PWM_Trigger_TCPWM__CNT_IDX 2u
#define PWM_Trigger_TCPWM__HW TCPWM0
#define PWM_Trigger_TCPWM__IDX 0u
#define Clock_Trigger__DIV_IDX 8
#define Clock_Trigger__DIV_NUM 0
#define Clock_Trigger__DIV_TYPE CY_SYSCLK_DIV_16_BIT
...
#define CY_PROJECT_NAME "UltraSonic"
