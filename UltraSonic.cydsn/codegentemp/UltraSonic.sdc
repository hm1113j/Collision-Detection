...
# Date: Fri, 27 Jan 2023 18:10:16 GMT
#set_units -time ns
...
create_generated_clock -name {Clock_Echo} -source [get_pins {ClockBlock/periclk}] -edges {1 5 9} [list [get_pins {ClockBlock/ff_div_11}]]
...
create_generated_clock -name {Clock_Trigger} -source [get_pins {ClockBlock/periclk}] -edges {1 501 1001} [list [get_pins {ClockBlock/ff_div_18}]]
