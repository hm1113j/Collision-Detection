...
get_filename_component(_filename "/home/ecofoxtrot/catkin_ws/src/laser_assembler/srv/AssembleScans.srv" NAME_WE)
add_custom_target(_laser_assembler_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "laser_assembler" "/home/ecofoxtrot/catkin_ws/src/laser_assembler/srv/AssembleScans.srv" "sensor_msgs/PointCloud:sensor_msgs/ChannelFloat32:geometry_msgs/Point32:std_msgs/Header"
)

get_filename_component(_filename "/home/ecofoxtrot/catkin_ws/src/laser_assembler/srv/AssembleScans2.srv" NAME_WE)
add_custom_target(_laser_assembler_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "laser_assembler" "/home/ecofoxtrot/catkin_ws/src/laser_assembler/srv/AssembleScans2.srv" "sensor_msgs/PointCloud2:sensor_msgs/PointField:std_msgs/Header"
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/laser_assembler)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/laser_assembler\")")
  # install generated code
  install(
