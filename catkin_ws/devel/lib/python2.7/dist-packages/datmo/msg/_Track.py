...
"""autogenerated by genpy from datmo/Track.msg. Do not edit."""
import codecs
import sys
...
class Track(genpy.Message):
  _md5sum = "9be6c9e185b709664a0c0610900da1e3"
  _type = "datmo/Track"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """int32 id 	               # object ID 
...
float64 y
float64 z"""
  __slots__ = ['id','length','width','odom']
  _slot_types = ['int32','float32','float32','nav_msgs/Odometry']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_i2f3I().pack(_x.id, _x.length, _x.width, _x.odom.header.seq, _x.odom.header.stamp.secs, _x.odom.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.length, _x.width, _x.odom.header.seq, _x.odom.header.stamp.secs, _x.odom.header.stamp.nsecs,) = _get_struct_i2f3I().unpack(str[start:end])
      start = end
      end += 4
...
def _get_struct_7d():
    ...
    return _struct_7d
_struct_i2f3I = None
def _get_struct_i2f3I():
    global _struct_i2f3I
    if _struct_i2f3I is None:
        _struct_i2f3I = struct.Struct("<i2f3I")
    return _struct_i2f3I
